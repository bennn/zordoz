...
(require/typed/provide compiler/zo-structs
               ...
               [#:struct (stx-obj zo) ([datum : Any]
                 [wrap : wrap]
                 [tamper-status : (U 'clean 'armed 'tainted)])]
               [#:struct (form zo) ()]
               [#:struct (expr form) ()]
               [#:struct (binding zo) ()]
               [#:struct (wrap zo) ([shifts : (Listof module-shift)]
               ...
               [#:struct (module-shift zo) ([from : (U #f Module-Path-Index)]
                 [to : (U #f Module-Path-Index)]
                 [from-inspector-desc : (U #f Symbol)]
                 [to-inspector-desc : (U #f Symbol)])]
               [#:struct (scope zo) ([name : (U 'root Natural)]
                 [kind : Symbol]
               ...
               [#:struct (multi-scope zo) ([name : Natural]
                 [src-name : Any]
                 [scopes : (Listof (List (U #f Integer) scope))])]
               [#:struct (module-binding binding) ([encoded : Any])]
               [#:struct (decoded-module-binding binding) ([path : (U #f Module-Path-Index)]
                 [name : Symbol]
                 [phase : Integer]
